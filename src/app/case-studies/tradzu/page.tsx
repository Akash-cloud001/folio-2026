    ...
    sections: [
        ...
        },
        {
            ...
            images: [
                ...
                {
                    title: 'Brand Merchandise & Offline Growth',
                    description:
                        'Physical apparel with QR-driven acquisition — scan to join Tradzu and get rewarded. Lime-green (#AFE607) identity carried from product UI into real-world marketing.',
                    image: '/tradzu-model.png',
                },
            ],
        },
        {
            ...
            items: [
                {
                    ...
                    description:
                        'Dark-first UI with neon-fintech identity, matte layered surfaces, and lime-green (#AFE607) across rewards, active states, and marketplace — tokenized theming closer to gaming and trading culture than traditional brokerage sites. Brand system extended to physical merchandise for offline-to-online acquisition via QR.',
                    image: '/tradzu-model.png',
                },
                {
